...
const SignUp = () => {
  ...
  const pasoUsuario = (entra) => {
    if (entra === true) {
      ...
      return "InicioPanelEscort";
    } else {
      console.log("lo sineto pero no.");
      return "InicioPanelEscort"; //Lo deje asi para seguir progrando la app deberia ir un "Ingresar"
    }
  };
  return (
                  ...
                  <div>
                    ...
                    <span className="botonEntrar">
                      ...
                      <Popup
                        ...
                        scrollbars="yes"
                        className="tamaño"
                        trigger={<input type="button" value="Registro"></input>}
                        modal
                        nested
                      >
                        {(close) => (
                          <PopupC agregarEditarUsuario={agregarEditarUsuario} />
                        )}
                      </Popup>
                    </span>
                  </div>
